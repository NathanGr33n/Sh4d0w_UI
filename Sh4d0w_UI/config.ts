...
class Config {
  ...
  validateAndSanitize(key: string, value: any): number | string | boolean | false {
    ...
    if (propertySchema.type === 'number') {
      ...
      if (propertySchema.minimum !== undefined && num < propertySchema.minimum) return false;
      if (propertySchema.maximum !== undefined && num > propertySchema.maximum) return false;
      return num;
    }
